            ...
            <table className="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="wd-total-activity">8:45:15</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                    ...
                    <tr>
                        ...
                        <td className="wd-total-activity">15:22:10</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">5:55:20</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">9:40:00</td>
                    </tr>
                </tbody>
            </table>
        </div>
