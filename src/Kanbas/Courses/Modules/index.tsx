    ...
    return (
        <div>
            <div className="wd-header">
                ...
                <button className="wd-button wd-add-module-button">+ Module</button>
            </div>
            <ul id="wd-modules">
                <li className="wd-module">
                    ...
                    <ul className="wd-lessons">
                        ...
                        <li className="wd-lesson">
                            ...
                            <ul className="wd-content">
                                <li className="wd-content-item">Full Stack Dev - Chapter 1 - Introduction</li>
                                <li className="wd-content-item">Full Stack Dev - Chapter 2 - Creating User</li>
                            </ul>
                        </li>
                        <li className="wd-lesson">
