    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                as large headings. There are 6 heading tags for different sizes: h1, h2, h3, h4, h5, and h6. 
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1"> 
                    ...
                    to add vertical spacing, wrap the paragraphs you want to separate with the paragraph tag
                </p>
                <p id="wd-p-2">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-favorite-recipe">
                    <li>Crack 2-3 eggs into a bowl and beat them until smooth.</li>
                    <li>Add salt and pepper to taste, then mix well.</li>
                    <li>Heat a pan over medium heat and add a small amount of butter or oil.</li>
                    <li>Pour the egg mixture into the pan and cook for 2-3 minutes, gently lifting the edges with a spatula.</li>
                    <li>Once the eggs are mostly set, fold the omelette in half and cook for an additional minute. Serve hot!</li>
                </ol>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Jack Reacher: Lee Child Series</li>
                    <li>Two States</li>
                    <li>Hunger Games</li>
                    <li>Insurgent</li>
                </ul>
            ...
            <div id="wd-forms">
                ...
                This is my 
                <a id="wd-github" href="https://github.com/Parthav-N"> Github </a> link <br />
